...
## Tomato Localization
# Constants
MODEL_PATH_YOLO = r'/home/pi/BOB_Inspection_Rover/models/yolov4-tiny-416.tflite'
IOU_THRESHOLD = 0.45
...
MODELL_PATH_RIPENESS = r'/home/pi/BOB_Inspection_Rover/models/ripe1.tflite'
MODEL_PATH_DEFECTIVENESS = r'/home/pi/BOB_Inspection_Rover/models/defective1.tflite'
...
LOG_FILE_PATH = r'/home/pi/BOB_Inspection_Rover/models/logs/tomatoes_log.csv' # Path to CSV where data is exported
...
def Felipe_Main_Camera(pipeline, aisle, plant):
    
    ## Get the image and extract the lozalization data
    Tomatoes_Collection, image, depth_frame = Get_Image_Data(pipeline)

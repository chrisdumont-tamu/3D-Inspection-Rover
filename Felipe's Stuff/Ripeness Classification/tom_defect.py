...
# Datasets
TRAIN_DS_DIR = r"datasets\in_use_datasets\defective\balanced_train_ds_oversample_binary"
TEST_DS_DIR = r"datasets\in_use_datasets\defective\balanced_test_ds_oversample_binary"
...
model = models.Sequential([
    ...
    layers.Conv2D(48, (3, 3), activation='relu'),    # Convoutional layer with relu attached
...
# model = models.Sequential([
    # resize_and_rescale,  # layer used to resize and reduce the data
    # data_augmentation,
    # layers.Conv2D(32, (3, 3), activation='relu', input_shape = PARAM_IMAGE_SHAPE[1:]),    # Convoutional layer with relu attached
    # layers.Conv2D(44, (3, 3), activation='relu'),
    # layers.Conv2D(56, (3, 3), activation='relu'),
    # layers.MaxPooling2D((2, 2)), # pooling layer for 2 by 2 area
    # layers.Conv2D(48, (3, 3), activation='relu'),    # Convoutional layer with relu attached
    # layers.Conv2D(64, (3, 3), activation='relu'),
    ...
    # layers.Dropout(0.2),
    # layers.Flatten(),   # layer to flatten the latest feature map
    # layers.Dense(48, activation='relu'),    # use a dense layer to for classification
    # layers.Dense(NUM_CLASSES, activation='softmax'),    # use softmax activation function to normalize probability of classes
# ])
...
# MODEL_SAVE_DIR = r'saved_models\defectiveness'
# MODEL_HIST_DIR = r'saved_models\defectiveness\model_history_logs'
# model_version = '_oversample_binary_80'

MODEL_SAVE_DIR = r'saved_models\tf_29\defectiveness29'
MODEL_HIST_DIR = r'saved_models\tf_29\defectiveness29\model_history_logs_tf29'
model_version = '_oversample_binary_80_tf29'

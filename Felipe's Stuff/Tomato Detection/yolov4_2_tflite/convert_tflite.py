...
# flags.DEFINE_string('weights', './checkpoints/yolov4-tiny-512-run4', 'path to weights file')
...
# flags.DEFINE_string('output', './checkpoints/yolov4-512-fp32.tflite', 'path to output')
# flags.DEFINE_string('output', './checkpoints/yolov4-608-fp32.tflite', 'path to output')
